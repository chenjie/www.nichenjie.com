...
这里可以参考我现在的 `.travis.yml` 配置，你可以在[这里](https://github.com/jellycsc/JellyBlog-Travis-CI/blob/master/.travis.yml)找到，主要就是以下代码：
...
Enjoy! 如果你有什么问题，欢迎在评论区中让我知道，你也可以直接在我的 [GitHub Repo](https://github.com/jellycsc/JellyBlog-Travis-CI) 中 Open Issue 或者 PR. Thanks for reading till the end!